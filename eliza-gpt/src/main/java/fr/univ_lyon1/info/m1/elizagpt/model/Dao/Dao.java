 ...
 * stockage (liste ou map) et
 * du type des identifiants (string ou entier).<br>
 * Si un support de persistance devait être ajouté au projet, il le serait dans les
...
public interface Dao<T> {
     ...
     * @throws NameAlreadyBoundException Si la clé est déjà existante
     */
